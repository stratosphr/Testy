...
class ASTSimplifierTest {
    ...
    public void simplifyArithExpr_ok() {
        ...
        SimpleNode expr = assertDoesNotThrow(BParser::parseExpr0);
        SimpleNode simplifiedNode = new ASTSimplifier().simplify(expr);
        assertEquals(13, simplifiedNode.jjtGetNumChildren());
        ...
        assertTrue(simplifiedNode.jjtGetChild(11) instanceof ASTNumber);
        ...
        assertEquals(Integer.toString(49), ((SimpleNode) simplifiedNode.jjtGetChild(11)).jjtGetValue());
        assertEquals(Integer.toString(50), ((SimpleNode) simplifiedNode.jjtGetChild(12)).jjtGetValue());
    }
